...
(() => {
  ...
  if (
    !localStorage.getItem("admitrolayout") &&
    !localStorage.getItem("admitronavstyles") &&
    !localStorage.getItem("admitroverticalstyles") &&
      ...
      switch (verticalStyle) {
        ...
        case "overlay":
          ...
          if (html.getAttribute('data-toggled') === 'icon-overlay-close') {
            ...
            if (window.innerWidth >= 992) {
              if (!localStorage.getItem("admitrolayout")) {
