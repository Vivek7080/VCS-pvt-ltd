...
function switcherClick() {
    ...
    let lightThemeVar = lightBtn.addEventListener('click', () => {
        lightFn();
        localStorage.setItem("admitroHeader", 'light');
    ...
    let lightMenuVar = lightMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("admitroMenu", 'light');
    });
    /* Light Menu End */
    ...
    let colorMenuVar = colorMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("admitroMenu", 'color');
    });
    /* Color Menu End */
    ...
    let gradientMenuVar = gradientMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("admitroMenu", 'gradient');
    });
    /* Gradient Menu End */
    ...
    let transparentMenuVar = transparentMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("admitroMenu", 'transparent');
    });
    ...
    let colorHeaderVar = colorHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("admitroHeader", 'color');
    });
    /* Color Header End */
    ...
    let gradientHeaderVar = gradientHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("admitroHeader", 'gradient');
    });
    /* Gradient Header End */
    ...
    let transparentHeaderVar = transparentHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("admitroHeader", 'transparent');
    });
    ...
    let fullwidthVar = fullwidthBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("admitrofullwidth", true);
    ...
    let shadowVar = regular.addEventListener('click', () => {
        ...
        localStorage.setItem("admitroregular", true);
        localStorage.removeItem("admitroclassic");
        localStorage.removeItem("admitromodern");
    });
    ...
    let noShadowVar = classic.addEventListener('click', () => {
        ...
        localStorage.setItem("admitroclassic", true);
        localStorage.removeItem("admitroregular");
        localStorage.removeItem("admitromodern");
    });
    ...
    let modernVar = modern.addEventListener('click', () => {
        ...
        localStorage.setItem("admitromodern", true);
        localStorage.removeItem("admitroregular");
        localStorage.removeItem("admitroclassic");
    });
    ...
    let fixedHeaderVar = fixedHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("admitroheaderfixed", true);
        localStorage.removeItem("admitroheaderscrollable");
    });

    let scrollHeaderVar = scrollHeaderBtn.addEventListener('click', () => {
        html.setAttribute('data-header-position', 'scrollable');
        localStorage.setItem("admitroheaderscrollable", true);
        localStorage.removeItem("admitroheaderfixed");
    });
    ...
    let fixedMenuVar = fixedMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("admitromenufixed", true);
        localStorage.removeItem("admitromenuscrollable");
    });

    let scrollMenuVar = scrollMenuBtn.addEventListener('click', () => {
        html.setAttribute('data-menu-position', 'scrollable');
        localStorage.setItem("admitromenuscrollable", true);
        localStorage.removeItem("admitromenufixed");
    });
    ...
    let defaultVar = defaultBtn.addEventListener('click', () => {
        ...
        toggleSidemenu();
        localStorage.removeItem("admitroverticalstyles");
    ...
    let closedVar = closedBtn.addEventListener('click', () => {
        closedSidemenuFn();
        localStorage.setItem("admitroverticalstyles", 'closed');
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
                ele.querySelector('ul').style.display = 'none'
    ...
    let detachedVar = detachedBtn.addEventListener('click', () => {
        detachedFn();
        localStorage.setItem("admitroverticalstyles", 'detached');
    });
    /* Hover Submenu End */
    ...
    let iconTextVar = iconTextBtn.addEventListener('click', () => {
        iconTextFn();
        localStorage.setItem("admitroverticalstyles", 'icontext');
    });
    ...
    let overlayVar = overlayBtn.addEventListener('click', () => {
        iconOverayFn();
        localStorage.setItem("admitroverticalstyles", 'overlay');
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
                ele.querySelector('ul').style.display = 'none'
    ...
    let doubleVar = doubleBtn.addEventListener('click', () => {
        doubletFn();
        localStorage.setItem("admitroverticalstyles", 'doublemenu');
    });
    ...
    let menuClickVar = menuClickBtn.addEventListener('click', () => {
        ...
        menuClickFn();
        localStorage.setItem("admitronavstyles", 'menu-click');
        localStorage.removeItem("admitroverticalstyles");
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
    ...
    let menuhoverVar = menuHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        menuhoverFn();
        localStorage.setItem("admitronavstyles", 'menu-hover');
        localStorage.removeItem("admitroverticalstyles");
    ...
    let iconClickVar = iconClickBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconClickFn();
        localStorage.setItem("admitronavstyles", 'icon-click');
        localStorage.removeItem("admitroverticalstyles");
    ...
    let iconhoverVar = iconHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconHoverFn();
        localStorage.setItem("admitronavstyles", 'icon-hover');
        localStorage.removeItem("admitroverticalstyles");
    ...
    let verticalVar = verticalBtn.addEventListener('click', () => {
        ...
        // local storage
        localStorage.removeItem("admitrolayout");
        localStorage.setItem("admitroverticalstyles", 'default');
        verticalFn();
        setNavActive();
    ...
    let horiVar = horiBtn.addEventListener('click', () => {
        ...
        html.removeAttribute('data-vertical-style');
        //    local storage
        localStorage.setItem("admitrolayout", 'horizontal');
        localStorage.removeItem("admitroverticalstyles");
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        if (ResetAll) {
            ...
            console.error("ResetAll element not found in the DOM.");
        }
    });
...
function lightFn() {
    ...
    localStorage.removeItem("admitrobgColor");
    localStorage.removeItem("admitroheaderbg");
    localStorage.removeItem("admitrobgwhite");
    localStorage.removeItem("admitromenubg");
    localStorage.removeItem("admitromenubg");
    checkOptions();
...
function verticalFn() {
    ...
    localStorage.removeItem('admitronavstyles');
...
function horizontalClickFn() {
    ...
    if(!localStorage.admitroMenu && !localStorage.bodylightRGB){
        html.setAttribute("data-menu-styles","light")
        document.querySelector('#switcher-menu-light').checked = true;
        checkOptions();
    }
...
function ResetAllFn() {
    let html = document.querySelector('html');
    if(localStorage.getItem("admitrolayout")=="horizontal"){
...
function checkOptions() {
    ...
    // dark
    if (localStorage.getItem('admitrodarktheme')) {
        document.querySelector('#switcher-dark-theme').checked = true;
    }
    ...
    // light header
    if (localStorage.getItem('admitroHeader') === "light") {
        document.querySelector('#switcher-header-light').checked = true;
    }

    // color header
    if (localStorage.getItem('admitroHeader') === "color") {
        document.querySelector('#switcher-header-primary').checked = true;
    }

    // gradient header
    if (localStorage.getItem('admitroHeader') === "gradient") {
        document.querySelector('#switcher-header-gradient').checked = true;
    }

    // dark header
    if (localStorage.getItem('admitroHeader') === "dark") {
        document.querySelector('#switcher-header-dark').checked = true;
    }
    // transparent header
    if (localStorage.getItem('admitroHeader') === "transparent") {
        document.querySelector('#switcher-header-transparent').checked = true;
    }

    // light menu
    if (localStorage.getItem('admitroMenu') === 'light') {
        document.querySelector('#switcher-menu-light').checked = true;
    }

    // color menu
    if (localStorage.getItem('admitroMenu') === 'color') {
        document.querySelector('#switcher-menu-primary').checked = true;
    }

    // gradient menu
    if (localStorage.getItem('admitroMenu') === 'gradient') {
        document.querySelector('#switcher-menu-gradient').checked = true;
    }

    // dark menu
    if (localStorage.getItem('admitroMenu') === 'dark') {
        document.querySelector('#switcher-menu-dark').checked = true;
    }
    // transparent menu
    if (localStorage.getItem('admitroMenu') === 'transparent') {
    ...
    //scrollable
    if (localStorage.getItem('admitroheaderscrollable')) {
        document.querySelector('#switcher-header-scroll').checked = true;
    }
    if (localStorage.getItem('admitromenuscrollable')) {
        document.querySelector('#switcher-menu-scroll').checked = true;
    }

    //fixed
    if (localStorage.getItem('admitroheaderfixed')) {
        document.querySelector('#switcher-header-fixed').checked = true;
    }
    if (localStorage.getItem('admitromenufixed')) {
        document.querySelector('#switcher-menu-fixed').checked = true;
    }

    //classic
    if (localStorage.getItem('admitroclassic')) {
        document.querySelector('#switcher-classic').checked = true;
    }

    //modern
    if (localStorage.getItem('admitromodern')) {
        document.querySelector('#switcher-modern').checked = true;
    }

    // sidemenu layout style
    if (localStorage.admitroverticalstyles) {
        let verticalStyles = localStorage.getItem('admitroverticalstyles');
    ...
    if (localStorage.admitronavstyles) {
        let navStyles = localStorage.getItem('admitronavstyles');
        switch (navStyles) {
            case 'menu-click':
                document.querySelector('#switcher-menu-click').checked = true;
                break;
...
function updateColors() {
    ...
    if (document.querySelector("#sales-analysis") !== null) {
        indexbar();
    }
}
updateColors()
